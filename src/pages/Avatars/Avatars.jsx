...
const Avatars = () => {
  ...
  //   AVATAR_IDS[0].male.asian[0]
  // );
  // Initially set the first avatar's id
  // const availableAvatars =
  //   AVATAR_IDS[0][selectedGender]?.[selectedEthnicity] || [];
  const availableAvatars =
  ...
  // Compute available avatars based on gender and ethnicity
  // const availableAvatars =
  //   AVATAR_IDS[0][selectedGender]?.[selectedEthnicity] || [];
  // Compute available avatars based on gender and ethnicity

  // Update selectedAvatar when gender or ethnicity changes
  // useEffect(() => {
  //   if (
  //     availableAvatars.length > 0 &&
  //     !availableAvatars.includes(selectedAvatar)
  //   ) {
  //     setSelectedAvatar(availableAvatars[0]);
  //   }
  // }, [selectedGender, selectedEthnicity, availableAvatars, selectedAvatar]);
  useEffect(() => {
    if (
      availableAvatars.length > 0 &&

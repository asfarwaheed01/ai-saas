...
const PostOrganizationContext = () => {
  ...
  return (
    <div className="docs-page">
      <div className="docs-page-header">
        <h1 className="docs-page-title">Create Organization Context</h1>
        <p className="docs-page-description">
          Create organization details (only allowed once per user).
        </p>
      </div>
      ...
      <div className="docs-section">
        <div className="docs-endpoint">
          ...
          <p className="docs-endpoint-description">
            This endpoint allows an authenticated user to create their
            organization details. Only one record can be created per user.
          </p>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>Organization details text (max 100,000 tokens)</td>
                </tr>
              </tbody>
            </table>
          </div>
  ...
  -d '{
    "organization_details": "Organization details text (max 100,000 tokens)"
  }'`}
            </pre>
          </div>
            ...
            <div className="docs-tabs-content">
              ...
              {showResponse && (
                <div className="docs-tab-pane active">
                  ...
                  <div className="docs-code">
                    <div className="docs-code-header">
                      <span>Example Response (201 Created)</span>
                      <button className="docs-code-copy">Copy</button>
                    </div>
                    <pre>
                      {`{
                ...
                <div className="docs-tab-pane active">
                  ...
                  <div className="docs-alert docs-alert-error">
                    ...
                    <div className="docs-alert-content">
                      ...
                      <p className="docs-alert-message">
                        Organization details already exist for this user.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="docs-alert docs-alert-error">
                    ...
                    <div className="docs-alert-content">
                      ...
                      <p className="docs-alert-message">
                        Failed to create organization details.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="docs-code">
                    ...
                    <pre>
                      {`{
  "error": "Bad Request",
  "message": "Organization details already exist",
  "status": 400
}`}
                    </pre>
                  </div>
...
export default PostOrganizationContext;
